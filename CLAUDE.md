...
- ALWAYS use `bun` for package management and running scripts (e.g., `bun install`, `bun run dev`, `bun run build`). Do not use npm or yarn. NEVER use `npx`. Use `bunx` natively instead.
