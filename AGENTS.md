...
3. **Package Manager**: Use `bun` exclusively for installing dependencies and running scripts. Do not use npm or yarn. NEVER use `npx`. Use `bunx` natively instead for all executables.
