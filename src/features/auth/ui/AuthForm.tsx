...
import { Button, FormField, GlassCard } from '@/shared/ui/core'
    ...
    if (mode === 'signup') {
      ...
      if (userType === 'aficionado') {
        const creatorChecked = (
          document.getElementById('creator-agreement') as HTMLInputElement | null
        )?.checked
        if (!creatorChecked) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: mode === 'signup' ? 'rgba(0,212,200,0.18)' : 'rgba(0,212,200,0.12)',
          filter: 'blur(60px)',
              ...
              <div className="animate-fade-in-up space-y-1.5">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      transform: `translateX(${userType === 'fan' ? '4px' : 'calc(100% + 0px)'})`,
                    }}
                    aria-hidden="true"
                  />
                ...
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-xs text-foreground/70 leading-relaxed">
                    ...
                    <span className="block text-muted-foreground mt-0.5">
                      Includes strict prohibition of adult content.
                    </span>
                  </span>
                </label>
