    ...
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-charcoal/95 backdrop-blur-md animate-fade-in transition-all">
      <div className="max-w-md w-full px-6 text-center">
        ...
        <p className="text-muted-foreground mb-16">
          We noticed you&apos;re jumping between pages quickly. Let&apos;s take a 15-second
          breathing break to center your mind.
        </p>
        ...
        <p className="text-sm text-primary/50 animate-pulse">Unlocking in a moment...</p>
      </div>
    </div>
  )
}
