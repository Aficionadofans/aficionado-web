  ...
  return (
    <div className="space-y-4 mb-10">
      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2 hide-scrollbar">
        <div className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold text-primary bg-primary/10 border border-primary/20 shrink-0 shadow-[0_0_10px_rgba(245,158,11,0.15)]">
        ...
        {TOPIC_FILTERS.map((topic) => {
          ...
          return (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-full text-xs font-semibold shrink-0 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
                isActive 
                  ? 'bg-primary text-black font-bold shadow-[0_0_15px_rgba(245,158,11,0.4)] scale-105' 
                  : 'liquid-glass text-muted-foreground hover:text-off-white hover:border-primary/40'
              }`}
            >
              #{topic}
            </button>
