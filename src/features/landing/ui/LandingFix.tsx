        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, i) => (
            <RevealSection key={stat.label} delay={i * 100}>
              <div className="liquid-glass glass-shimmer-sweep p-6 sm:p-8 flex flex-col justify-between h-full group text-left relative overflow-hidden rounded-[1.75rem]">
                <div>
                  <span
