...
export function DangerZoneCard() {
  return (
    <Card
      className="liquid-glass-hover border-destructive/20 overflow-hidden animate-fade-in-up transition-all duration-500"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl bg-destructive/5 border border-destructive/10">
          <div className="mb-4 sm:mb-0">
            ...
            <p className="text-xs text-muted-foreground mt-1 max-w-sm">
              Permanently remove your account, all check-ins, posts, and data from our servers. This
              cannot be undone.
            </p>
          </div>
