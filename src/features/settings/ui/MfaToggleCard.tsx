...
function SubmitButton({
  ...
  let className =
    'px-6 py-2.5 text-sm font-semibold transition-all duration-300 rounded-full active:scale-95 disabled:opacity-50 '

  if (variant === 'primary') {
    className +=
      'bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_4px_14px_0_rgba(0,240,181,0.39)] hover:shadow-[0_6px_20px_rgba(0,240,181,0.5)]'
    ...
    className +=
      'bg-white/10 text-off-white border border-white/20 hover:bg-white/20 hover:border-white/30'
  }
          ...
          {isEnrolled ? (
            ...
            <div className="space-y-8 animate-fade-in-up">
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Open your authenticator app (like Google Authenticator, Authy, or 1Password) and
                  scan this QR code.
                </p>
                <div
            ...
            <div>
              <p className="text-sm text-muted-foreground mb-6">
                Two-factor authentication is currently disabled. We strongly recommend enabling it
                to protect your wellness data.
              </p>
              <form
                action={enrollAction}
                onSubmit={() => {
