  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-[#090401]">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div
          className="absolute top-3/4 left-1/2 w-[300px] h-[300px] rounded-full bg-[#E8501A]/6 blur-[100px] animate-float mix-blend-screen"
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-12 z-10">
        ...
        <div className="md:hidden mb-8 text-center animate-fade-in-up">
          ...
          <p className="mt-2 text-sm text-muted-foreground">The anti-dopamine social network.</p>
        </div>

        <Suspense
          fallback={<div className="animate-pulse w-full max-w-sm h-96 bg-white/5 rounded-3xl" />}
        >
          <AuthForm />
        </Suspense>
      </div>
